...
public class Lesson_1_grammar_2_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson_1_grammar_2_results);
        ...
        String answersJson = readRawTextFile(context, getResources().getIdentifier("l1_g2_answersjson", "raw", "com.popkova.russianlanguageapp"));
        for (int i = 0; i < 15; i++) {
            String answerReceived = getIntent().getExtras().getString("L1G2A" + Integer.toString(i));
            try {
                JSONObject jsonObject = new JSONObject(answersJson);
                String answerTrue = jsonObject.getString("L1G2A" + Integer.toString(i));
        ...
        defaultRatingBar.setRating((scoreForAGame/15)*2);
